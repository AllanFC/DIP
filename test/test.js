import YatzyDice from "./person.js"
let die = new YatzyDice();
...
//Functions
die.throwDice(holds);
console.log(die.getValues());
console.log(die.getThrowCount());
